...
let canvas, context, backgroundImg, trumpImg, targetImg, canvasWidth, canvasHeight, slingX, slingY, size, trumpSize, targetSize, maxTargets, targets, x, y, stretchX, stretchY, releaseX, releaseY, dragStartX, counter, screenOffset, startOffset, targetsRemaining, frame, mode;
...
function loop() {
    ...
    //Draw Trump
    context.drawImage(trumpImg, frame, canvasHeight, trumpSize, trumpSize, x - screenOffset, y, trumpSize, trumpSize);
...
window.addEventListener("DOMContentLoaded", () => {
    ...
    //Push total number of targets into array
    for (let i = 0; i < maxTargets; i++) {
        let target = {
            x: null,
            y: null,
...
function mouseDown(e) {
    let pointerX = e.clientX; //Gets coordinates of mouse click BEFORE release
...
function mouseMove(e) {
    let pointerX = e.clientX; //Gets coordinate of mouse AFTER release
    let pointerY = e.clientY;
